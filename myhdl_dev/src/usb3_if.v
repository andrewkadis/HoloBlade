...
// dc_fifo_almost_full       : Goes high when therea are 40 items in FIFO and then clears at 1
...
always @(posedge ftdi_clk) begin: USB3_IF_USB3_READOUT_LOGIC_STATE
    ...
    case (state)
        3'b000: begin
            if (((FR_RXF == 1'b0) && (dc_fifo_almost_full == 1'b0))) begin
                state <= 3'b010;
        ...
        3'b100: begin
            if ((dc_fifo_almost_full == 1'b1)) begin
                FT_OE <= 1'b1;
                FT_RD <= 1'b1;
                state <= 3'b001;
            end
        ...
        3'b001: begin
            if ((dc32_fifo_is_full == 1'b0)) begin
                state <= 3'b000;
            end
        end
    endcase
