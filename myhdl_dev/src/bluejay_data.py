...
@block
def bluejay_data(fpga_clk, next_frame_rdy, fifo_data_out, start_clocking_frame_data, line_of_data_available, fifo_empty, get_next_word, data_o, sync, valid):
...
def bluejay_data_tb():
    ...
    bluejay_data_inst = bluejay_data(fpga_clk, next_frame_rdy, fifo_data_out, start_clocking_frame_data, line_of_data_available, fifo_empty, get_next_word, bluejay_data_o, sync, valid)
