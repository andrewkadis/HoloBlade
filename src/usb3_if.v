...
always @(negedge ftdi_clk) begin: USB3_IF_USB3_READOUT_LOGIC_STATE
    ...
    if ((reset_per_frame_latched == 1'b1)) begin
        ...
        case (state)
            3'b000: begin
                if (((buffer_switch_done_latched == 1'b1) && (dc32_fifo_empty == 1'b1))) begin
...
always @(FT_RD_internal, FT_OE_internal, FR_RXF) begin: USB3_IF_WRITE_TO_DC_FIFO_LOGIC
    FT_RD = FT_RD_internal;
    FT_OE = FT_OE_internal;
    if (((FR_RXF == 1'b0) && (FT_OE_internal == 1'b0) && (FT_RD_internal == 1'b0))) begin
