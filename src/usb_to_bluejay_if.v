...
always @(negedge clk_i) begin: USB_TO_BLUEJAY_IF_USB_OUTPUT_ENABLE
    if ((fifo_empty_o == 1)) begin
        fifo_output_enable_o <= 0;
        get_next_word_o      <= 1;
    end
    else begin
        fifo_output_enable_o <= 1;
        get_next_word_o      <= 1;
    end
end
