...
output [3:0] STATE_DEBUG_B0;
reg [3:0] STATE_DEBUG_B0;
...
always @(posedge fpga_clk) begin: USB3_IF_LATCH_FROM_FPGA_CLOCK
    ...
    dc32_fifo_empty_latched <= dc32_fifo_empty;
end
    ...
    if ((reset_per_frame_latched == 1'b1)) begin
        ...
        case (state)
            ...
            4'b0010: begin
                state_timeout_counter <= (state_timeout_counter - 1);
                if ((state_timeout_counter == 1)) begin
                    if ((dc32_fifo_empty_latched == 1'b1)) begin
...
always @(posedge ftdi_clk) begin: USB3_IF_FLAG_STATE_CHANGE_DEBUG
    case (state)
        4'b0000: begin
            STATE_DEBUG_B0 <= 4'h1;
        end
